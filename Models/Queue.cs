...
namespace QueueLess.Models
{
    public class Queue
    {
        ...
        [Required]
        [MaxLength(EntityValidation.Queue.NameMaxLength)]
        public string Name { get; set; } = null!;

        [MaxLength(EntityValidation.Queue.DescriptionMaxLength)]
        public string? Description { get; set; }

        [Required]
        [Range(EntityValidation.Queue.AverageServiceTimeMin, EntityValidation.Queue.AverageServiceTimeMax)]
